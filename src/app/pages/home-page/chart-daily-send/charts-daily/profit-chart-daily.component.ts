...
@Component({
  selector: 'ngx-profit-chart-daily',
  styleUrls: ['./charts-common-daily.component.scss'],
  template: `
    <div echarts [options]="options" class="echart" (chartInit)="onChartInit($event)"></div>
  `,
})
export class ProfitChartDailyComponent implements AfterViewInit, OnDestroy, OnChanges {
