...
@Component({
  selector: 'ngx-chart-panel-header-daily',
  styleUrls: ['./chart-panel-header-daily.component.scss'],
  templateUrl: './chart-panel-header-daily.component.html',
})
export class ChartPanelHeaderDailyComponent implements OnDestroy {
